...
image_paths = [
    'C:/Users/JUDITHDELCARMENPADRO/Documents/python/triangulo.png',
    'C:/Users/JUDITHDELCARMENPADRO/Documents/python/cuadrado.png',
    'C:/Users/JUDITHDELCARMENPADRO/Documents/python/circulo.png',
]
...
# Crear el modelo
model = Sequential([
    Input(shape=(64, 64, 3)),  # Definir la entrada explícitamente
    Flatten(),
...
# Cargar modelo y procesar imagen para detección de contornos
model = tf.keras.models.load_model('shape_detector_model.h5')

# Cargar la imagen principal
image = cv2.imread('C:/Users/JUDITHDELCARMENPADRO/Documents/python/FigurasColores.png')
if image is None:
    raise FileNotFoundError("No se pudo cargar la imagen principal.")
